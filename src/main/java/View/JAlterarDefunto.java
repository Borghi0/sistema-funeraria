...
public class JAlterarDefunto extends javax.swing.JFrame {
    ...
    public void carregarDefunto(Defunto defunto) {
        ...
        carregarData(defunto.getData_natalidade(), cbDiaNasc, cbMesNasc, cbAnoNasc);
        carregarData(defunto.getData_Obito(), cbDiaObito, cbMesObito, cbAnoObito);
        cbTipoObito.setSelectedItem(defunto.getTipo_Obito());
    }
    
    private void initInfo(){
        cxNomeDefunto.setText(defunto.getNome());
        cbDiaNasc.setSelectedItem(defunto.getData_natalidade());
        cbMesNasc.setSelectedItem(defunto.getData_natalidade());
        cbAnoNasc.setSelectedItem(defunto.getData_natalidade());
        cbDiaObito.setSelectedItem(defunto.getData_Obito());
        cbMesObito.setSelectedItem(defunto.getData_Obito());
        cbAnoObito.setSelectedItem(defunto.getData_Obito());
        cxCemiterio.setText(defunto.getCemiterio());
